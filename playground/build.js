...
const SOURCE_FILES = [
  ...
  'src/parser/theme-ast.js',
  'src/parser/auth-ast.js',
  '__AST_SHIM__',
  ...
  'src/parser/theme-parser.js',
  'src/parser/auth-parser.js',
  ...
  'src/analyzer/cli-analyzer.js',
  'src/analyzer/edge-analyzer.js',
  'src/analyzer/deploy-analyzer.js',
  'src/analyzer/concurrency-analyzer.js',
  'src/analyzer/auth-analyzer.js',
  ...
  'src/registry/plugins/theme-plugin.js',
  'src/registry/plugins/auth-plugin.js',
  ...
  for (const entry of SOURCE_FILES) {
    if (entry === '__AST_SHIM__') {
      ...
      for (const astFile of [
        ...
        'src/parser/deploy-ast.js', 'src/parser/theme-ast.js',
        'src/parser/auth-ast.js',
      ]) {
